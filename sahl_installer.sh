...
for arg in "$@"; do
    if [ "$arg" == "--with-startup-files" ]; then
        ...
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/.bash_logout
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/.bash_profile
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/.bashrc
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/.profile
        cp .bash_logout .bash_profile .bashrc .profile ~
        mkdir -p etc
        cd etc
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/etc/bashrc
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/etc/profile
        sudo cp -v bashrc profile /etc/
        mkdir -p profile.d
        cd profile.d
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/etc/profile.d/bash_completion.sh
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/etc/profile.d/extrapaths.sh
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/etc/profile.d/i18n.sh
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/etc/profile.d/readline.sh
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/etc/profile.d/umask.sh
        curl -O https://github.com/abdurahman-harouat/sahl/raw/refs/heads/dev/bash_startup_files/etc/profile.d/dircolors.sh
